...
{isModalOpen && selectedConversation && (
  <>
    {/* Full Screen Backdrop - Higher z-index than sidebar */}
    <div
    ...
    <div className="fixed inset-0 z-[110] flex items-center justify-center p-2 sm:p-4 pointer-events-none">
      <div className="bg-white rounded-lg shadow-xl w-full h-full sm:h-[600px] sm:max-w-4xl flex overflow-hidden pointer-events-auto">
        ...
        <div className="flex-1 flex flex-col">
          ...
          <div className="p-3 sm:p-4 border-b border-gray-200 flex items-center justify-between">
            <div className="flex items-center space-x-3">
              <div className={`w-8 h-8 sm:w-10 sm:h-10 ${getAvatarColor(selectedConversation.other_user.id)} rounded-full flex items-center justify-center text-white text-xs sm:text-sm font-bold`}>
                {getInitials(selectedConversation.other_user.name)}
              </div>
              <div>
                <h3 className="font-semibold text-gray-900 text-sm sm:text-base">{selectedConversation.other_user.name}</h3>
          ...
          <div className="p-3 sm:p-4 border-t border-gray-200">
            <form onSubmit={sendMessage} className="flex items-center space-x-2 sm:space-x-3">
              <input
                ...
                className="flex-1 border border-gray-300 rounded-lg px-3 sm:px-4 py-2 text-sm sm:text-base focus:outline-none focus:ring-2 focus:ring-blue-500"
                disabled={sending}
                style={{ fontSize: '16px' }}
                onKeyDown={(e) => {
              ...
              <button
                  ...
                  className={`text-white p-2 rounded-lg min-h-[44px] min-w-[44px] flex items-center justify-center transition-colors ${
